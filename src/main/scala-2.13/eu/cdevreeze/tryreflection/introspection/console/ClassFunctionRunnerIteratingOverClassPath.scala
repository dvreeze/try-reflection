...
object ClassFunctionRunnerIteratingOverClassPath extends ManagedLogger {
  ...
  def main(args: Array[String]): Unit = {
    require(
      args.sizeIs == 3,
      s"Usage: ClassFunctionRunnerIteratingOverClassPath <JSON config resource path> <ClassFunction JSON config resource path> <classpath file> "
    )
    ...
    val mainClassName: String =
      "eu.cdevreeze.tryreflection.introspection.console.internal.InternalClassFunctionRunnerIteratingOverClassPath"
